...
func findUserByVerificationCode (code string) {
...
func sendVerificationEmail (email, verificationCode string) {
	...
	message.SetBody("text/plain", "Hi, You are receiving this email because we want to verify if this email address is indeed yours \n
	Kindly use the 8 digit code below to verify your email address. \n \n
